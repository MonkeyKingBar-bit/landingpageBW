<?php get_header(); ?>
   <div class="about" id="about" style="background: url(<?= CFS()->get('background_black') ?>) center 101% repeat-x, url(<?= CFS()->get('background_white') ?>) center 101% repeat-x, #1d1d1d;">
      <div class="container">
      ...
      <div class="container">
         ...
         <div class="provide__inner">
            ...
            <div class="provide__item">
               ...
               <p class="provide__item-text">
                  DAenean nisi lectus, convallis non lorem sit amet, rhoncus
                  malesuada justo
               </p>
            </div>
         </div>
   ...
   <div class="contact" id="contact">
      ...
      <div class="contact__inner">
         <div class="contact__icon-box">
            <div class="contact__item">
               ...
               <div class="contact__text">
                  <a href="tel:555222333">555-222-333</a>
               </div>
            </div>
            <div class="contact__item">
               <i class="icon-location"></i>
               <div class="contact__text">
                  <a href="https://goo.gl/maps/QV1TchfcoWN65fXM7" target="_blank">Here is some address</a>
               </div>
            </div>
            <div class="contact__item">
         ...
         <form class="contact__form" action="">
            ...
            <input class="contact__btn" type="submit" value="Submit" />
         </form>
      </div>
   </div>
<?php get_footer() ?>